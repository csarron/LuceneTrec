...
public class MMapDirectory extends FSDirectory {
  ...
  */
   ...
   */
  public static final boolean UNMAP_SUPPORTED = AccessController.doPrivileged((PrivilegedAction<Boolean>) () -> {
      try {
   ...
   */
  public static final String UNMAP_NOT_SUPPORTED_REASON = "UNMAP_NOT_SUPPORTED_REASON";
  
  /** Reference to a BufferCleaner that does unmapping; {@code null} if not supported. */
  private static final BufferCleaner CLEANER = (resourceDescription, buffer) -> {
      try {
          ...
          throw new IOException("Unable to unmap the mapped buffer: " + resourceDescription, e.getCause());
      }
  };
//  static {
